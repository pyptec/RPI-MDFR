...
# Ruta al archivo .env
load_dotenv(dotenv_path="/home/pi/.scr/.scr/.env")
...
def obtener_datos_medidores_y_sensor():
    ...
    config_CT01CO2 = util.cargar_configuracion('/home/pi/.scr/.scr/device/ct01co2.yml', 'ct01co2_sensor')
    medicion_CT01CO2 = payload_event_CT01CO2(config_CT01CO2)  # Obtener la medición como JSON
    medicionSensorCT01CO2 = json.dumps(medicion_CT01CO2)  # Convertir a JSON con formato legible
